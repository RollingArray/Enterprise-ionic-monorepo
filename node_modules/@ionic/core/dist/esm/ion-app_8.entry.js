...
import { a as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-3eb591f3.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-a6723622.js').then((module) => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-2829e8ee.js').then((module) => module.startInputShims(config));
        }
